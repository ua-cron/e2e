...
export const testBs4Classes = (code: string) => {
  ...
  describe(`Bootstrap4 classes: ${code}, ${cronType}`, () => {
  ...
  describe(`Bootstrap4 classes: ${code}, ${cronType} with prefix "my-"`, () => {
    beforeEach(() => {
