...
export const getDayClasses = (type: string, cssClassPrefix = '', bs: 'bs4'|'bs5') => {
  if (bs === 'bs4') {
    return getDayClassesBs4(type, cssClassPrefix);
  }
  return getDayClassesBs5(type, cssClassPrefix);
};

export const getDayClassesBs5 = (type: string, cssClassPrefix = '') => {
  const { getCronType } = getSharedHelper(type);

  return {
    everyWeekday: (() => {
      const box = `.${cssClassPrefix}mb-3.c-every-weekday.c-segment`;
    ...
    incrementWeekday: (() => {
      const box = `.${cssClassPrefix}mb-3.${cssClassPrefix}align-items-center.${cssClassPrefix}d-flex.c-increment-weekday.c-segment`;
      ...
      const control = `${box} select.${cssClassPrefix}form-control.${cssClassPrefix}form-control-sm.${cssClassPrefix}w-auto.${cssClassPrefix}mx-1.c-increment-weekday-every`;
      const control2 = `${box} select.${cssClassPrefix}form-control.${cssClassPrefix}form-control-sm.${cssClassPrefix}w-auto.${cssClassPrefix}mx-1.c-increment-weekday-from`;
    ...
    incrementMonthday: (() => {
      const box = `.${cssClassPrefix}mb-3.${cssClassPrefix}align-items-center.${cssClassPrefix}d-flex.c-increment-monthday.c-segment`;
      ...
      const control = `${box} select.${cssClassPrefix}form-control.${cssClassPrefix}form-control-sm.${cssClassPrefix}w-auto.${cssClassPrefix}mx-1.c-increment-monthday-every`;
      const control2 = `${box} select.${cssClassPrefix}form-control.${cssClassPrefix}form-control-sm.${cssClassPrefix}w-auto.${cssClassPrefix}mx-1.c-increment-monthday-from`;
    ...
    andWeekday: (() => {
      const box = `.${cssClassPrefix}mb-3.c-and-weekday.c-segment`;
      ...
      const itemsBox = `${box} .${cssClassPrefix}row.${cssClassPrefix}ps-3.${cssClassPrefix}pt-1.c-and-weekday-list`;
    ...
    andMonthday: (() => {
      const box = `.${cssClassPrefix}mb-3.c-and-monthday.c-segment`;
      ...
      const itemsBox = `${box} .${cssClassPrefix}row.${cssClassPrefix}ps-3.${cssClassPrefix}pt-1.c-and-monthday-list`;
    ...
    lastMonthday: (() => {
      const box = `.${cssClassPrefix}mb-3.c-last-monthday.c-segment`;
    ...
    lastWeekday: (() => {
      const box = `.${cssClassPrefix}mb-3.c-last-weekday.c-segment`;
    ...
    lastNth: (() => {
      const box = `.${cssClassPrefix}mb-3.${cssClassPrefix}align-items-center.${cssClassPrefix}d-flex.c-last-nth.c-segment`;
      ...
      const control = `${box} select.${cssClassPrefix}form-control.${cssClassPrefix}form-control-sm.${cssClassPrefix}w-auto.${cssClassPrefix}mx-1.c-last-nth-weekday`;
    ...
    dayBeforeEnd: (() => {
      const box = `.${cssClassPrefix}mb-3.${cssClassPrefix}align-items-center.${cssClassPrefix}d-flex.c-day-before-end.c-segment`;
      ...
      const control = `${box} select.${cssClassPrefix}form-control.${cssClassPrefix}form-control-sm.${cssClassPrefix}w-auto.${cssClassPrefix}mx-1.c-day-before-end-monthday`;
    ...
    nearest: (() => {
      const box = `.${cssClassPrefix}mb-3.${cssClassPrefix}align-items-center.${cssClassPrefix}d-flex.c-nearest.c-segment`;
      ...
      const control = `${box} select.${cssClassPrefix}form-control.${cssClassPrefix}form-control-sm.${cssClassPrefix}w-auto.${cssClassPrefix}mx-1.c-nearest-monthday`;
    ...
    nth: (() => {
      const box = `.${cssClassPrefix}mb-3.${cssClassPrefix}align-items-center.${cssClassPrefix}d-flex.c-nth.c-segment`;
      ...
      const control = `${box} select.${cssClassPrefix}form-control.${cssClassPrefix}form-control-sm.${cssClassPrefix}w-auto.${cssClassPrefix}mx-1.c-nth-every`;
      const control2 = `${box} select.${cssClassPrefix}form-control.${cssClassPrefix}form-control-sm.${cssClassPrefix}w-auto.${cssClassPrefix}mx-1.c-nth-every-weekday`;
...
export const getDayClassesBs4 = (type: string, cssClassPrefix = '') => {
  const { getCronType } = getSharedHelper(type);
